...
namespace jornalinterativo21e1de63
{
    ...
    public class jornalinterativo21e1de63
    {
        ...
        public jornalinterativo21e1de63() {
            ...
            var parametersRegexPattern = $"^/news/(?<{partitionKeyName}>[^/]+)";
            if (hasSortKey) {
