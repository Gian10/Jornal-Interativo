...
namespace jornalinterativo516c9fae
{
    ...
    public class jornalinterativo516c9fae
    {
        ...
        public jornalinterativo516c9fae() {
            ...
            var parametersRegexPattern = $"^/comments/(?<{partitionKeyName}>[^/]+)";
            if (hasSortKey) {
